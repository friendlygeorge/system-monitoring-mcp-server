...
export function registerSystemLogsTools(server: McpServer): void {
  server.tool(
    "system_logs",
    "Read recent system logs from journald. Filter by service, priority, or time range. Useful for diagnosing issues.",
    {
